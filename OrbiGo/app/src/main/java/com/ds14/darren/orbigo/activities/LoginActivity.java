...
import com.ds14.darren.orbigo.adapters.ViewPagerAdapter;
import com.ds14.darren.orbigo.broadcast_receivers.ConnectivityReceiver;
import com.ds14.darren.orbigo.constants.Constants;
import com.ds14.darren.orbigo.fragments.LoginFragment;
import com.ds14.darren.orbigo.fragments.SignUpFragment;
    ...
    private void checkIfLoggedIn() {
        ...
        if(currentUser!=null){
            ...
            if(mode.equals(Constants.TVT)) {
                startActivity(new Intent(LoginActivity.this, SplashTouristActivity.class));
                finish();
            }
